...
/**
 * Interface representing the washing options for a laundry process. This interface defines the
 * various settings and parameters that can be used to configure a washing operation.
 */
