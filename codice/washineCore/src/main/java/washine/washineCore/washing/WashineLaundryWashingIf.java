...
/**
 * Interface representing the basic functionality for managing a laundry washing operation.
 * This interface defines the methods for retrieving the washing operation's details and options.
 */
public interface WashineLaundryWashingIf {
    ...
    /**
     * Gets the current load of the washing operation, representing how much laundry has been added so far.
     * 
