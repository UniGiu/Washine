...
public class WashineWashingOptions implements WashineLaundryWashingOptionsIf, WashineLaundryWashingOptionsLaunderIf {
	...
	public WashineWashingOptions(int visibilityTime, int dateTime, int durationMinutes, double initialLoad,
			double maxLoad, String temperature, String spinSpeed, String fabricType, String color,
			String detergentTypes, boolean underwear, String refundTypes, String pickupAddress, String deliveryAddress,
			String drying, String pickupAvailability, String deliveryAvailability, boolean ironing,
			double participantMaxLoad, int washingAccessOpenDate, int washingAccessCloseDate) {
	...
	public void reset() {
		...
		ironing = false;
		participantMaxLoad = 0;
		washingAccessOpenDate = 0;
		washingAccessCloseDate = 0;
	}
}
